...
<div class="bg-white h-screen w-screen sm:px-8 md:px-16 sm:py-8">
    <main class="container mx-auto max-w-screen-lg h-full">
        <!-- file upload modal -->
        @php
            if (Route::currentRouteName() == 'hidayyahImages') {
                $action = route('hidayyah.image.upload');
            } else {
                $action = route('sunday.image.upload');
            }
        @endphp
            ...
            <article aria-label="File Upload Modal" class="relative h-full flex flex-col bg-white shadow-xl rounded-md"
                ...
                <section class="h-full overflow-auto p-8 w-full h-full flex flex-col">
                    <header
                        ...
                        <input id="hidden-input" name="images[]" type="file" multiple class="hidden" />
