                ...
                <form method="POST" action="{{ route('doctor.store') }}">
                    ...
                    <div class="mx-auto lg:w-1/2 md:w-2/3">
                        <div class="flex flex-wrap -m-2">
                            ...
                            <div class="w-1/2 p-2">
                                <div class="relative">
                                    <label for="number" class="text-sm leading-7 text-gray-600">Department
                                        ID</label>
                                    <input type="number" id="email" name="department_id"
                                        class="w-full px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-gray-100 bg-opacity-50 border border-gray-300 rounded outline-none focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200">
                                </div>
                            </div>
                            <div class="w-1/2 p-2">
                            ...
                            <div class="w-1/2 p-2">
                                <div class="relative">
                                    <label for="email" class="text-sm leading-7 text-gray-600">Clinic/Hospital
                                        Address</label>
                                    <input type="text" id="email" name="hospital_address"
                                        class="w-full px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-gray-100 bg-opacity-50 border border-gray-300 rounded outline-none focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200">
                                </div>
                            </div>
                            <div class="w-1/2 p-2">
                            ...
                            <div class="w-1/2 p-2">
                                <div class="relative">
                                    <label for="name" class="text-sm leading-7 text-gray-600">Extra
                                        Services</label>
                                    <input type="text" id="name" name="extra"
                                        class="w-full px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-gray-100 bg-opacity-50 border border-gray-300 rounded outline-none focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200">
                                </div>
                            </div>
