        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div class="flex flex-col ml-3">
                    ...
                    <p class="mt-1 text-sm leading-none text-gray-600">By Deleting you will loos your Appointmnet.</p>
                </div>
            </div>
            <form method="post" action="{{ route('appointment.destroy', ['id' => $del_id]) }}">
            @csrf
            <button type="submit"
